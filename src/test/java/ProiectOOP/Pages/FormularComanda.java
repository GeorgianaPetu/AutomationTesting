...
public class FormularComanda {
    ...
    public void metodaFormularComanda(String judetSector, String oras, String adresa) {
        ...
        //assert
        WebElement prenume = driver.findElement(By.xpath("/html/body/div[1]/div/div/div/div[1]/div/main/div[2]/section/div/div/section/form/fieldset/div[3]/div[1]/div/input"));
        prenumeText = prenume.getText();
