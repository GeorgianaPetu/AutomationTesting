...
public class ModificareDate {
    ...
    public void metodaModificareDate(String prenume, String nume, String email, String telefon, String judetSector, String oras, String adresa) {
        this.nume = nume;
        this.prenume = prenume;
        this.email = email;
        this.telefon = telefon;
        ...
        prenumeField.clear();
        elementsMethods.fillElement(prenumeField, prenume);
        delay.metodaDelaySec(1);
        numeField.clear();
        elementsMethods.fillElement(numeField, nume);
        delay.metodaDelaySec(1);
        telefonField.clear();
        elementsMethods.fillElement(telefonField, telefon);
        delay.metodaDelaySec(1);
